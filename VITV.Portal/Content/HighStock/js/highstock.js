...
(function () {
    ...
    L.offset, za = L.map, z = L.addEvent, T = L.removeEvent, N = L.fireEvent, cc = L.washMouseEvent, qb = L.animate, fb = L.stop; M = {
        ...
        }, credits: { enabled: !0, text: "vitsoftware.vn", href: "http://www.vitsoftware.vn", position: { align: "right", x: -10, verticalAlign: "bottom", y: -5 }, style: { cursor: "pointer", color: "#909090", fontSize: "9px" } }
